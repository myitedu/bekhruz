...
<head>
    ...
    <!-- Page Title -->
    <title>Folio - Multipurpose Portfolio HTML Template</title>
    <!-- Icon fonts -->
...
<body id="home">
    ...
    <div class="page-wrapper">
        ...
        <!-- end of header -->
        <!-- start of hero -->
        <section class="wpo-hero-style-2">
            <div class="wpo-slide-wrap">
                ...
                <div class="wpo-slide-right-img">
                    <div class="slide-img wow fadeInRightSlow" data-wow-duration="2000ms">
                        <img src="assets/images/slider/hero-shape.png" alt="image">
                    </div>
                </div>
            </div>
        </section>
        <!-- end of hero slider -->
        <!-- wpo-wpo-exprience-area start -->
                        ...
                        <div class="wpo-about-wrap">
                            <div class="tab-content">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="wpo-counter-grids">
                                                    <div class="grid">
                                                        <div>
                                                            <h2><span class="odometer" data-count="75">00</span>%</h2>
                                                        </div>
                                                        <p>Communication Skills</p>
                                                    </div>
                                                    <div class="grid">
                                                        <div>
                                                            <h2><span class="odometer" data-count="90">00</span>%</h2>
                                                        </div>
                                                    ...
                                                    <div class="grid">
                                                        <div>
                                                            <h2><span class="odometer" data-count="55">00</span>%</h2>
                                                        </div>
                                                    ...
                                                    <div class="grid">
                                                        <div>
                                                            <h2><span class="odometer" data-count="82">00</span>%</h2>
                                                        </div>
                                                        <p>Creativity</p>
                                                    </div>
                                                </div>
                                ...
                                <div id="Social" class="tab-pane">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-6 col-sm-6  custom-grid col-12">
                                            <div class="wpo-social-wrap">
                                                <div class="wpo-social-icon">
                                                    <i class="fa fa-facebook"></i>
                                                </div>
                                                <div class="wpo-social-text">
                                                    <h2>Facebook</h2>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div id="Award" class="tab-pane">
                                    <div class="wpo-award-wrap">
                                        <div class="row">
                                            <div class="col-md-6 col-sm-6">
                                                <div class="wpo-award-img">
                                                    <img src="assets/images/about/award.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                                <div class="wpo-award-img">
                                                    <img src="assets/images/about/award2.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                                <div class="wpo-award-img">
                                                    <img src="assets/images/about/award3.jpg" alt="">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-sm-6">
                                                <div class="wpo-award-img">
                                                    <img src="assets/images/about/award4.jpg" alt="">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        <section class="wpo-contact-area section-padding">
                    ...
                    <div class="col-md-4 col-sm-6 custom-grid col-12">
                        <div class="wpo-blog-wrap">
                            ...
                            <div class="wpo-blog-text">
                                ...
                                <h2><a href="blog.html">Helpful tips for become a successful designer</a></h2>
